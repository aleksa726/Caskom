    ...
    <div class="cela_strana_moj_profil">
        ...
        <div class="wrapper_moj_profil">
            ...
            <div class="desno_moj_profil">
                ...
                <h1 class='naslov_sekcije' style="margin-top: 10vh;">Boost oglasa</h1>
                <hr>
                ...
                <div class="div_pretplacivanja">
                    ...
                    <form method="post" action="<?php echo base_url("Korisnik/dodajFotografijeUplatnicaBoost/$oglas->idO"); ?>" enctype="multipart/form-data">
