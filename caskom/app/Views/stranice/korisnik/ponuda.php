    ...
    <div class="cela_strana_moj_profil">
        ...
        <div class=linija_menija id='navbar' style="background-color: rgb(28, 28, 29);">
            ...
            <div class=meni_info>
                <ul>
                    ...
                    <li><a href='<?php echo base_url('Korisnik/klikNaPonudu'); ?>' class="ponuda">Ponuda</a></li>
        ...
        <div class="wrapper_moj_profil">
            <div class="levo_moj_profil">
                ...
                <form method="get" action="<?php echo site_url("Korisnik/filtriranje")?>">
            ...
            <div class="desno_moj_profil">
                ...
                if(isset($oglasi)){
                  ...
                  foreach ($oglasi as $oglas) {
                       ...
                       if($oglas->boostovan == true){
                        $url =   site_url("Korisnik/dodajUListuZelja/$oglas->idO/$page");
                        
                        echo "
                        <div class='moji_istaknuti_oglasi' >
                            <div class='div_oglasa istaknuti_div'>
                                
                                <a class='dodaj_u_listu_istaknuti' href='$url'></a>
                            ...
                            <div class='moji_istaknuti_oglasi' >
                                <div class='div_oglasa'>
                                    <a class='dodaj_u_listu' href='$url'></a>
                                    <a class='link_za_klik' href='$urlOglasa'>
                ...
                ?>
                    ...
                    <div class="div_dugme_pretplati_se">    
                        <a href="<?php  $page=$page-2;  echo base_url("Korisnik/ponuda/$page"); ?>">
                        ...
                        <a href="<?php if(count($oglasi)==16) {$page=$page+2; echo base_url("Korisnik/ponuda/$page");} ?>">
                            <div class="dugme_pretplati_se">
                                <h3>Sledeca ></h3>
                            </div>
                        </a>
