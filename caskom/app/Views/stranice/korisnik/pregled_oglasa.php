...
<body onload="cena()">
            ...
            <div class="div_pregleda">
                ...
                <div class="div_slika_i_informacija">
                    ...
                    <div class="desno_informacije">
                        ...
                        <a href="<?php echo base_url("Korisnik/korisnik/$korisnik->idK")?>"><?php echo "<span class='prodavac'>$korisnik->korisnicko_ime</span>"?></a>
    ...
    localStorage.setItem('idKkome','<?php echo $korisnik->idK?>');
                      ...
                      <a href="<?php echo base_url('Korisnik/kontaktiranje'); ?>">
